...
function WorkingStep({ step, index }: { step: (typeof workingSteps)[number]; index: number }) {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-[32%_1fr] gap-[6%] text-[16px] leading-[1.5] transition-transform duration-300 hover:translate-x-2 max-[800px]:grid-cols-1 max-[800px]:gap-3">
...
export function WorkingSection() {
  return (
    <section className={sectionClass} id="working">
      ...
      <div className="scroll-reveal my-[75px] mr-0 mb-[105px] ml-[17%] grid grid-cols-[1.25fr_.75fr] items-end gap-[8%] max-[800px]:my-[60px] max-[800px]:mb-[75px] max-[800px]:ml-0 max-[800px]:grid-cols-1 max-[800px]:gap-[45px]">

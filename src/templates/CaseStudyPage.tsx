    ...
    <>
      ...
      <main className="overflow-hidden">
        <section className="grid min-h-[82svh] grid-cols-[17%_1fr] content-start border-b border-line px-[3vw] pt-[77px] pb-[100px] max-[800px]:block max-[800px]:min-h-[78svh] max-[800px]:px-[5vw] max-[800px]:pt-[55px] max-[800px]:pb-[70px]">
          ...
          <p className={`${meta} m-0 max-[800px]:mt-[35px]`}>{props.eyebrow}</p>
          <ExpertiseEffects
            className="relative col-start-2 my-[12vh] mb-[55px] max-w-[1200px] max-[800px]:mb-[45px]"
            intensity={0.58}
          >
            <h1
          ...
          <p className="col-start-2 m-0 max-w-[720px] text-[21px] leading-[1.45] max-[800px]:text-[17px]">
            {props.lead}
          </p>
        </section>
        ...
        <section className="grid grid-cols-[17%_1fr_1fr] gap-[5%] border-b border-line px-[3vw] py-[100px] max-[800px]:grid-cols-1 max-[800px]:gap-[45px] max-[800px]:px-[5vw] max-[800px]:py-[75px]">
          ...
          <article className="border-t border-ink pt-5">
            ...
            <p className="text-[18px] leading-[1.6]">{props.context}</p>
          </article>
          <article className="border-t border-ink pt-5">
            <h3 className={meta}>Challenge</h3>
            <p className="text-[18px] leading-[1.6]">{props.challenge}</p>
          </article>
        </section>

        {props.image ? (
          <ExpertiseEffects
            className="relative aspect-[3558/1920] min-h-[390px]"
            intensity={0.55}
          >
          ...
          <figure
            className="relative h-[65svh] min-h-[500px] overflow-hidden bg-[#20221e] max-[800px]:h-[50svh] max-[800px]:min-h-[390px]"
        ...
        <section className="border-b border-line px-[3vw] py-[110px] max-[800px]:px-[5vw] max-[800px]:py-[75px]">
          <h2 className={label}>How the work evolved</h2>
          <div className="mt-[70px] ml-[17%] border-t border-ink max-[800px]:mt-[55px] max-[800px]:ml-0">
            {props.phases.map((phase, index) => (
              ...
              >
                ...
                <p className="mt-[3px] text-[16px] leading-[1.6] max-[800px]:col-start-2">
                  {phase.text}
                </p>
              </article>
            ))}
        ...
        <section className="ml-[17%] grid grid-cols-2 gap-[7%] border-b border-line px-[3vw] py-[100px] max-[800px]:ml-0 max-[800px]:grid-cols-1 max-[800px]:gap-[60px] max-[800px]:px-[5vw] max-[800px]:py-[75px]">
          <div className="border-t border-ink pt-[22px]">
            <h2 className={label}>Contribution</h2>
            <ul className="mt-[45px] list-none p-0">
              {props.contributions.map((item) => (
                <li className="border-b border-line py-3.5 text-[16px]" key={item}>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="border-t border-ink pt-[22px]">
            ...
            <ExpertiseEffects className="relative mt-[45px]" intensity={0.45}>
              <p
        ...
        <section className="grid grid-cols-[17%_1fr] border-b border-line px-[3vw] py-[110px] max-[800px]:grid-cols-1 max-[800px]:gap-[55px] max-[800px]:px-[5vw] max-[800px]:py-[75px]">
          <h2 className={label}>What this demonstrates</h2>
          <ExpertiseEffects className="relative max-w-[1150px]" intensity={0.45}>
            <p
        ...
        <Link
          className="flex items-end justify-between border-b border-line px-[3vw] py-[55px] max-[800px]:block max-[800px]:px-[5vw] max-[800px]:py-10"
          href={props.next.href}
        >
          <span className={meta}>Next case study</span>
          <ExpertiseEffects
            className="relative max-[800px]:mt-[22px]"
            intensity={0.45}
          >
            <span
